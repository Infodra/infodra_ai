...
export function HeroSection() {
  return (
    <section
      className="relative flex items-center justify-center overflow-hidden bg-cover bg-center min-h-screen pt-32 pb-24"
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute w-[500px] h-[500px] -top-48 -left-48 bg-primary-400 rounded-full mix-blend-screen filter blur-3xl opacity-20 animate-float"></div>
        <div className="absolute w-[500px] h-[500px] top-1/3 -right-48 bg-accent-400 rounded-full mix-blend-screen filter blur-3xl opacity-20 animate-float" style={{ animationDelay: '2s' }}></div>
        <div className="absolute w-[500px] h-[500px] -bottom-48 left-1/3 bg-primary-500 rounded-full mix-blend-screen filter blur-3xl opacity-20 animate-float" style={{ animationDelay: '4s' }}></div>
      </div>
      ...
      <div className="relative max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="animate-fade-in">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-[1.15] text-white">
            ...
            <span className="block whitespace-nowrap bg-gradient-to-r from-primary-200 via-white to-accent-200 bg-clip-text text-transparent pb-2">
              Lower Cost — Powered by AI.
            </span>
          </h1>

          <p className="text-xl md:text-2xl text-primary-100 mb-8 max-w-[820px] mx-auto leading-relaxed">
            Practical AI for the factory floor and the engineering office — automated inspection, intelligent production monitoring, predictive maintenance and engineering automation that deliver measurable results within months.
          </p>
